========================================================================
    APLICACIÓN DE WIN32: jetpac 
                         Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación jetpac.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación jetpac.
...
small.ico
    Este es un archivo de icono, que contiene una versión menor (16x16) del 
    icono de la aplicación. Este icono está incluido en el archivo principal 
    de recursos jetpac.rc.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado jetpac.pch y un archivo de tipos 
